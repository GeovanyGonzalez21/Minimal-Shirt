...
<head>
    ...
    <meta name="description" content="Página web curso emprendedores de negocios" />
    <meta name="author" content="Geovany González - Pablo López" />
    <title>Minimal Shirt</title>
    <!-- Favicon-->
...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#team">Preguntas frecuentes</a></li>
    ...
    <header class="masthead">
        <div class="container">
            ...
            <div class="masthead-heading text-uppercase">¿Imagina usar una camiseta que refleje tu personalidad única?
            </div>
    ...
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Minimal shirt</h2>
                <h3 class="section-subheading text-muted">¡Descubre la magia de la autoexpresión con nuestras camisetas
                    personalizadas! Crea tu estilo único, imprime tus ideas y viste la creatividad. ¡Convierte cada
                    prenda en una obra maestra que cuente tu historia! Bienvenido a Minimal Shirt, donde la moda se
                    encuentra con la individualidad.</h3>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="my-3">Personalización</h4>
                    <p class="text-muted">Eleva tu estilo con personalizaciones en negro, blanco y dorado, ofreciendo
                        una gama exclusiva de opciones.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="my-3">Tallas disponibles</h4>
                    <p class="text-muted">Encuentra el ajuste perfecto en tallas desde la S hasta la XL, garantizando
                        comodidad y elegancia en cada prenda.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="my-3">Materiales de primera calidad</h4>
                    <p class="text-muted">Experimenta la excelencia con materiales de primera calidad, cuidadosamente
                        seleccionados para ofrecer una experiencia de uso superior.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="my-3">Servicio de entrega en todo el país</h4>
                    <p class="text-muted">Experimenta la excelencia con materiales de primera calidad, cuidadosamente
                        seleccionados para ofrecer una experiencia de uso superior.</p>
                </div>
                <div class="col-md-4">
                    ...
                    <h4 class="my-3">Personal capacitado</h4>
                    <p class="text-muted">Disfruta de un seguimiento detallado de tu diseño, asegurando que cada prenda
                        sea una expresión auténtica de tu estilo personal.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <h4 class="my-3">Proceso de compra completamente en línea</h4>
                    <p class="text-muted">Compra sin complicaciones desde la comodidad de tu hogar con nuestro proceso
                        de compra en línea, rápido, seguro y fácil.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">¿Te gustaría vestir con el mejor estilo?</h3>
            </div>
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/1.jpg" alt="Diseño personalizado"
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/2.jpg" alt="Playera Satoru Gojo"
                                style="width: 500px;height: 300px;" />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/3.jpg" alt="Playera coding"
                                style="width: 500px;height: 300px;" />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/4.jpg" alt="Playera tanjiro"
                                style="width: 500px;height: 300px;" />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/5.jpg" alt="Messi"
                                style="width: 500px;height: 300px;" />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/6.jpg" alt="CR7"
                                style="width: 500px;height: 300px;" />
                        </a>
                        <div class="portfolio-caption">
    ...
    <section class="page-section" id="about">
        <div class="container">
            ...
            <!-- Separación entre titulo y subtitulos... -->
            <br>
            <h3 class="section-subheading text-muted">Explora nuestra Misión y Visión: Transformamos cada hilo en una
                experiencia excepcional. Descubre cómo nuestra pasión por la calidad y el compromiso con la excelencia
                nos guían hacia un futuro lleno de innovación y servicio excepcional. ¡Acompáñanos en este viaje
                inspirador hacia la excelencia!</h3>

            <div class="row">
                <!-- Elemento de Visión -->
                <div class="col-lg-6 vision-container">
                    <div class="text-center">
                        <img class="rounded-circle img-fluid" src="assets/img/about/2.jpg" alt="Visión" />
                        <br>
                        <br>
                        <h2 class="section-heading text-uppercase">Visión</h2>
                        <p class="justificar-texto">
                            Nuestra visión es destacar como referentes en la industria guatemalteca, ofreciendo
                            productos innovadores y servicios de vanguardia en el campo de las playeras serigráficas.
                            Buscamos no solo satisfacer, sino superar las expectativas de nuestros clientes,
                            proporcionando una amplia gama de camisas serigráficas de primera calidad respaldadas por
                            asesoramiento experto y una atención al cliente excepcional.
                        </p>
                    </div>
                </div>
                ...
                <!-- Elemento de Misión -->
                <div class="col-lg-5 mission-container">
                    <div class="text-center">
                        <img class="rounded-circle img-fluid" src="assets/img/about/1.jpg" alt="Misión" />
                        <br>
                        <br>
                        <h2 class="section-heading text-uppercase">Misión</h2>
                        <p class="justificar-texto">
                            Nuestra misión es ser líderes en el mercado guatemalteco al ofrecer a nuestros clientes
                            productos de la más alta calidad y un servicio excepcional en el ámbito de las playeras
                            serigráficas. Nos comprometemos a satisfacer plenamente las necesidades de nuestros clientes
                            mediante la provisión de una amplia variedad de camisas serigráficas de alta calidad,
                            respaldadas por asesoramiento experto y atención al cliente excepcional.
                        </p>
                    </div>
                </div>
            </div>
...
?>
    ...
    <footer class="footer py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start">Copyright &copy;Minimal Shirt</div>
                <div class="col-lg-4 my-3 my-lg-0">
                    <!--Perfil de x (twitter)-->
                    <a class="btn btn-dark btn-social mx-2" href="https://twitter.com/" target="_blank"
                        aria-label="Twitter"><i class="fab fa-twitter"></i></a>
                    <!--Perfil de facebook-->
                    <a class="btn btn-dark btn-social mx-2"
                        href="https://www.facebook.com/profile.php?id=61557021059974&mibextid=kFxxJD" target="_blank"
                        aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
                    <!--Perfil de instagram--->
                    <a class="btn btn-dark btn-social mx-2"
                        href="https://www.instagram.com/art_minimal_shirt?igsh=ZmRoYm9zaHZ3Ym84" target="_blank"
                        aria-label="Instagram"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                    <!--Perfil de whatsapp-->
                    <a class="btn btn-dark btn-social mx-2" href="whatsapp://send?phone=+50258226530" target="_blank"
                        aria-label="WhatsApp"><i class="fab fa-whatsapp" aria-hidden="true"></i></a>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <p class="item-intro text-muted">¿Tienes una idea en mente?</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/1.jpg" alt="..." />
                                <div class="justificar-texto">
                                    <p> ¡Haz realidad tus ideas y envíanos tu diseño personalizado! Desde tus
                                        ilustraciones únicas hasta tus frases inspiradoras, transformamos tu creatividad
                                        en una playera única. Destaca con un estilo que es completamente tuyo. ¡Envía tu
                                        diseño hoy y lleva contigo una declaración de moda personal!</p>
                                </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                <!-- Project details-->
                                <h2 class="text-uppercase">Satoru Gojo</h2>
                                <p class="item-intro text-muted">Expansión de dominio: Vacio infinito</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/2.jpg" alt="..." />
                                <div class="justificar-texto">
                                    <p>Vacío Inconmensurable es un vacío literal de espacio que parece llevar al
                                        oponente al centro mismo del universo con un conocimiento inhumano, es decir,
                                        que la técnica se encarga de crear un espacio ilimitado, donde los oponentes
                                        aparentemente pueden ver y sentir todo, pero la información que reciben es
                                        interminable.</p>
                                </div>
                                <ul class="list-inline">
                                    <li>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                <!-- Project details-->
                                <h2 class="text-uppercase">Lógica programada</h2>
                                <p class="item-intro text-muted">¿Funciona? ¿Por qué?</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/3.jpg" alt="..." />
                                <div class="justificar-texto">
                                    <p>es la elección perfecta para aquellos que entienden que la esencia del desarrollo
                                        reside en dos simples preguntas: "Funciona, ¿por qué?" y "No funciona, ¿por qué
                                        no?". Este diseño inteligente y divertido encapsula la mentalidad del
                                        programador, donde cada línea de código es un rompecabezas por resolver.</p>
                                </div>
                                <ul class="list-inline">
                                    <li>
                                        <strong>Categoría:</strong>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                <!-- Project details-->
                                <h2 class="text-uppercase">Tanjiro Kamado</h2>
                                <p class="item-intro text-muted">¡Perseverancia inquebrantable y la bondad sin límites!
                                </p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/4.jpg" alt="..." />
                                <p>Con nuestra camisa exclusiva de Tanjiro Kamado, puedes llevar contigo el espíritu
                                    valiente y la fuerza interior que han cautivado a millones de fans en todo el mundo!
                                    Diseñada con cuidado y detalle, esta camisa es más que una prenda de vestir; es una
                                    declaración de tu conexión con el viaje de Tanjiro hacia la justicia y la redención.
                                </p>
                                <ul class="list-inline">
                                    <li>
                                        <strong>Categoría:</strong>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                <!-- Project details-->
                                <h2 class="text-uppercase">¡Magia Messi!</h2>
                                <p class="item-intro text-muted">¿Te gustaría ir de gala?</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/5.jpg" alt="..." />
                                <div class="justificar-texto">
                                    <p>a sea que estés en el estadio, en la cancha o simplemente disfrutando del juego
                                        desde casa, la "Magia Messi" te envuelve en la energía ganadora del ícono del
                                        fútbol. Viste con estilo y celebra la genialidad de Messi con esta playera que
                                        rinde homenaje a la pasión y la maestría en cada movimiento. </p>
                                </div>
                                <ul class="list-inline">
                                    <li>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                <!-- Project details-->
                                <h2 class="text-uppercase">CR7 Power Jersey</h2>
                                <p class="item-intro text-muted">¿Necesitas un poco de magia?</p>
                                <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/6.jpg" alt="..." />
                                <div class="justificar-texto">
                                    <p>Lleva contigo la fuerza y el magnetismo de Cristiano con cada paso, ya sea en la
                                        cancha de fútbol o en la vida diaria. La "Elegancia en Oro Negro" no solo es una
                                        prenda, sino una expresión de tu determinación y estilo de alto nivel. Descubre
                                        la fusión perfecta entre la sobriedad y el lujo con esta playera que te conecta
                                        con la grandeza de Cristiano Ronaldo.</p>
                                </div>
                                <ul class="list-inline">
                                    <li>
                                        <strong>Categoría:</strong>
